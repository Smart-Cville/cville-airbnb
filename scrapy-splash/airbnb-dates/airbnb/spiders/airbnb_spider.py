...
class AirbnbSpider(Spider):
	...
	def parse(self, response):
		...
		# FOR CHARLOTTESVILLE WE DONT THINK THIS IS NEEDED (<350 listings)

		# Construction of URLs
		URL_frag1 = r"https://www.airbnb.com/s/Charlottesville--VA--United-States/homes?refinement_paths%5B%5D=%2Fhomes&allow_override%5B%5D=&price_max="
		URL_frag2 = r"&ne_lat=38.08806282130956&ne_lng=-78.43516759277344&sw_lat=37.986526005631156&sw_lng=-78.53404454589844&zoom=13&search_by_map=true&checkin=2020-11-02&checkout=2020-11-06&price_min="
		URL_frag3 = r""

		lastURL = r"https://www.airbnb.com/s/Charlottesville--VA--United-States/homes?refinement_paths%5B%5D=" + r"%2F" + r"homes&allow_override%5B%5D=&ne_lat=38.08806282130956&ne_lng=-78.43516759277344&sw_lat=37.986526005631156&sw_lng=-78.53404454589844&zoom=13&search_by_map=true&checkin=2020-11-02&checkout=2020-11-06&price_min=999"
	...
	def parse_OnePage(self, response):
		...
		URL_frag1 = 'https://www.airbnb.com' # removed trailing /
		...
		# actual listing.
		prices = response.xpath('//span[@class="_1p7iugi"]/text()').getall()
